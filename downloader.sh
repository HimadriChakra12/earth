...
curl -O https://raw.githubusercontent.com/4urora3night/aurora-pac/refs/heads/main/lib/aur_helper.sh
curl -O https://raw.githubusercontent.com/4urora3night/aurora-pac/refs/heads/main/lib/core.sh
